...
int main(int argc, char *argv[])
{
    ...
    cout << "Model trained!" << '\n';
    raw_base_data = model.transform(nb, xb);
    ...
    query_raw_data = model.transform(nq, xq);
    ...
    cout << "Search took " << search_time << " s" << endl;
